...
void InitConsole(void){
		...
		//GPIO_PORTA_AFSEL_R ;	// Enable alt function on PA1, PA0
		//GPIO_PORTA_PCTL_R  ;	// Set PCT to choose UART alt function on PortA
		//GPIO_PORTA_AMSEL_R  ;	// Clear AMSEL to disable analog
		//GPIO_PORTA_DEN_R  ;		// Enable PA1, PA0
